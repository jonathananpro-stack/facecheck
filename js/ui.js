export const UI = {
    ...
    showValidation: (name) => { document.getElementById('validation-overlay').innerHTML = `Xác nhận ${name}? <button onclick="handleValidation('${name}')">OK</button>`; document.getElementById('validation-overlay').style.display = 'block'; },
